...
var obj = ref.obj;
return [_vm._l((_vm.findAllCustomSlotKeys(obj)),function(i,index){return _vm._t(i,null,{"obj":obj})})]}}})],null,true)})],2)]:(obj.schema.type === 'wrap')?[_c('div',_vm._b({on:{"click":function($event){return _vm.onEvent($event, obj)}}},'div',_vm.bindSchema(obj),false),[_vm._t(_vm.getKeyLabelSlot(obj),[_c('span',{domProps:{"innerHTML":_vm._s(obj.schema.label)}})],{"obj":obj}),_c('v-form-base',{class:(_vm.id + "-" + (obj.key)),attrs:{"id":(_vm.id + "-" + (obj.key)),"model":_vm.setValueWrap(obj),"schema":obj.schema.schema,"row":_vm.getRowGroupOrArray(obj),"col":_vm.getColGroupOrArray(obj)},scopedSlots:_vm._u([_vm._l((_vm.findAllCustomSlotKeys(obj)),function(i,index){return {key:i,fn:function(ref){
var obj = ref.obj;
...
// CONCATENATED MODULE: ./src/components/vFormBase.vue?vue&type=template&id=31354a2c&
