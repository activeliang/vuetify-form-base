...
// CONCATENATED MODULE: ./src/components/vFormBase.vue?vue&type=template&id=4c4fc322&
...
/* harmony default export */ var vFormBasevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    combineObjectsToArray: function combineObjectsToArray(_ref) {
      ...
      if (Array.isArray(this.storeStateData) && this.storeStateData.length > 1 && Array.isArray(this.storeStateSchema)) keys = keys.sort(function (a, b) {
