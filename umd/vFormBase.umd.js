(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vFormBase"] = factory(require("vue"));
	else
		root["vFormBase"] = factory(root["Vue"]);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"44a53776-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/vFormBase.vue?vue&type=template&id=e41fc11c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-row',_vm._b({directives:[{name:"resize",rawName:"v-resize.quiet",value:(_vm.onResize),expression:"onResize",modifiers:{"quiet":true}}],attrs:{"id":_vm.ref}},'v-row',_vm.getRow,false),[_vm._t(_vm.getFormTopSlot()),_vm._t("default"),_c('div',[_vm._v("=======> main: setValue -> "+_vm._s(_vm.dp(_vm.flatCombinedArraySorted)))]),_c('div',[_vm._v("=======> main2: setValue2 -> "+_vm._s(_vm.dp(_vm.flatCombinedArray)))]),_c('div',[_vm._v("=======> main3: setValue2 -> "+_vm._s(_vm.dp(_vm.storeStateData)))]),_c('div',[_vm._v("=======> main4: setValue2 -> "+_vm._s(_vm.dp(_vm.storeStateSchema)))]),_vm._l((_vm.flatCombinedArraySorted),function(obj,index){return [_c('v-tooltip',_vm._b({key:index,attrs:{"disabled":!obj.schema.tooltip},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
var on = ref.on;
...
// CONCATENATED MODULE: ./src/components/findField.js
...
var handleValue = function handleValue(data, path, key, obj, callback, callback2) {
  if (data && callback(data, key, obj)) {
    callback2(path.concat(key));
  }
};

var findField = function findField(obj, callback) {
  var result = [];
  ...
  var findKey = function findKey(obj) {
    ...
    if (obj instanceof Array) {
      for (var i = 0; i < obj.length; ++i) {
        handleValue(obj[i], path, i, obj, callback, function (v) {
      ...
      for (var key in obj) {
        handleValue(obj[key], path, key, obj, callback, function (v) {
          return result.push(v);
        });

        if (obj[key] instanceof Object) {
          var _newPath = deepCopy(path);

          _newPath.push(key);

          findKey(obj[key], _newPath);
        }
      }
    }
  };
...
/* harmony default export */ var components_findField = (findField);
...
function v_mask_esm_defineProperty(obj, key, value) {
  if (key in obj) {
    Object.defineProperty(obj, key, {
      value: value,
      enumerable: true,
...
function v_mask_esm_ownKeys(object, enumerableOnly) {
  var keys = Object.keys(object);
...
function v_mask_esm_objectSpread2(target) {
  for (var i = 1; i < arguments.length; i++) {
    var source = arguments[i] != null ? arguments[i] : {};

    if (i % 2) {
      v_mask_esm_ownKeys(Object(source), true).forEach(function (key) {
        v_mask_esm_defineProperty(target, key, source[key]);
      });
    } else if (Object.getOwnPropertyDescriptors) {
      Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));
    } else {
      v_mask_esm_ownKeys(Object(source)).forEach(function (key) {
        Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
      });
    }
  }
...
function createOptions() {
  ...
  function get(el) {
    return elementOptions.get(el) || v_mask_esm_objectSpread2({}, defaultOptions);
  }

  function partiallyUpdate(el, newOptions) {
    elementOptions.set(el, v_mask_esm_objectSpread2(v_mask_esm_objectSpread2({}, get(el)), newOptions));
  }
...
function extendMaskReplacers(maskReplacers) {
  ...
  return Object.keys(maskReplacers).reduce(function (extendedMaskReplacers, key) {
    ...
    return v_mask_esm_objectSpread2(v_mask_esm_objectSpread2({}, extendedMaskReplacers), {}, v_mask_esm_defineProperty({}, key, value));
  }, baseMaskReplacers);
}
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/vFormBase.vue?vue&type=script&lang=js&
...
/* harmony default export */ var vFormBasevue_type_script_lang_js_ = ({
  ...
  computed: {
    customSlotKeys: function customSlotKeys() {
      if (this.slotKeys.length) {
        return this.slotKeys;
      }

      var t = this.findAllCustomSlotKeys(this.schema);
      return t;
    },
    ...
    flatCombinedArraySorted: function flatCombinedArraySorted() {
      return Object(lodash["orderBy"])(this.flatCombinedArray, ['schema.sort'], [orderDirection]);
    },
    ...
    addPaths: function addPaths() {
      return function (obj, paths) {
        obj.paths = [].concat(_toConsumableArray(paths), [obj.key]);
        return obj;
      };
    }
  },
  ...
  watch: {
    schema: {
      deep: true,
      handler: function handler(newSchema) {
  ...
  methods: {
    ...
    bindSchemaMenu: function bindSchemaMenu(obj) {
      return _objectSpread2(_objectSpread2({}, defaultPickerSchemaMenu), obj.schema.menu);
    },
    ...
    //
    // customSlotKey
    getCustomSlotKeyArray: function getCustomSlotKeyArray(obj) {
      return Object.keys(obj.schema.schema);
    },
    findAllCustomSlotKeys: function findAllCustomSlotKeys(obj) {
      var result = [];
      components_findField(obj, function (v, k, obj) {
    ...
    simplePrePaths: function simplePrePaths() {
      var target = JSON.parse(JSON.stringify(this.prePaths));
    ...
    gridMapper: function gridMapper(obj, prepender) {
      if (obj) ['sm', 'md', 'lg', 'xl'].map(function (k) {
        if (obj[k]) {
    ...
    getGridAttributes: function getGridAttributes(obj) {
      ...
      colAttr ? Object(lodash["isPlainObject"])(colAttr) ? colAttr : Object(lodash["isNumber"])(colAttr) || Object(lodash["isString"])(colAttr) ? {
        cols: colAttr
      } : {
        cols: 'auto'
      ...
      this.gridReplaceXS(colObject, 'cols'); // schema definition of offset

      var offset = obj.schema.offset;
      var offsetObject = offset ? Object(lodash["isPlainObject"])(offset) ? offset : {
        offset: offset
      } : offset;
      this.gridMapper(offsetObject, 'offset-');
      this.gridReplaceXS(offsetObject, 'offset'); // schema definition of offset

      var order = obj.schema.order;
      var orderObject = order ? Object(lodash["isPlainObject"])(order) ? order : {
        order: order
      } : order;
    ...
    toCtrl: function toCtrl(params) {
      ...
      return params.obj.schema && Object(lodash["isFunction"])(params.obj.schema.toCtrl) ? params.obj.schema.toCtrl(params) : params.value;
    },
    fromCtrl: function fromCtrl(params) {
      ...
      return params.obj.schema && Object(lodash["isFunction"])(params.obj.schema.fromCtrl) ? params.obj.schema.fromCtrl(params) : params.value;
    },
    ...
    drop: function drop(event, obj) {
      ...
      if (Object(lodash["isFunction"])(obj.schema.drop)) obj.value = this.dropValue(obj, event);
    ...
    onEvent: function onEvent() {
      ...
      var index = this.index; // avoid circular JSON in dragstart
    ...
    updateArrayFromState: function updateArrayFromState(data, schema) {
      this.flatCombinedArray.forEach(function (obj) {
        obj.value = Object(lodash["get"])(data, obj.key, null); // get - lodash

        obj.schema = Object(lodash["get"])(schema, obj.key, null); // get - lodash
      });
    },
    sanitizeShorthandType: function sanitizeShorthandType(key, schema) {
      ...
      return Object(lodash["isString"])(schema) ? {
        type: schema,
        label: key
      } : schema;
    },
    ...
    flattenAndCombineToArray: function flattenAndCombineToArray(data, schema) {
      ...
      var flattenedObjects = this.flattenObjects(data, schema); // ... and combine them to an array
...
// CONCATENATED MODULE: ./src/components/vFormBase.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_vFormBasevue_type_script_lang_js_ = (vFormBasevue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/components/vFormBase.vue
...
var component = normalizeComponent(
  components_vFormBasevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var vFormBase = (component.exports);
// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (vFormBase);
...
//# sourceMappingURL=vFormBase.umd.js.map